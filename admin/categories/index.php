...
// لتفعيل العنصر في الشريط الجانبي
...
:root {
  ...
  --gdy-accent:  #22c55e;
  --gdy-warning: #eab308;
  /* التصميم الموحد للعرض: لا يتداخل مع السايدبار */
  --gdy-shell-max: min(880px, 100vw - 360px);
}

/* منع التمرير الأفقي على مستوى الصفحة (المحتوى نفسه أضيق من الشاشة) */
html, body {
  overflow-x: hidden;
}
...
/* حاوية التصميم الموحد للعرض */
.admin-content.container-fluid {
  padding-top: 1rem;
  padding-bottom: 1rem;
}

/* محتوى داخلي بعرض كامل الحاوية */
.gdy-layout-wrap {
  width: 100%;
}
...
/* تقليل الحشو لتقليل المسافات الأفقية */
.table-cats th,
.table-cats td {
  padding: .22rem .32rem;
}

/* ضبط عرض الأعمدة (الوصف/عدد الأخبار/إجراءات) */
