...
// admin/users/delete.php — حذف مستخدم
...
if ($method !== 'POST') {
    ...
    echo "<!doctype html><html lang='ar' dir='rtl'><head><meta charset='utf-8'><meta name='viewport' content='width=device-width,initial-scale=1'><title>حذف المستخدم</title>" .
         ...
         "<div class='card'><h2 style='margin:0 0 10px'>حذف المستخدم</h2><p class='muted'>سيتم حذف المستخدم نهائياً. تأكد قبل المتابعة.</p>" .
