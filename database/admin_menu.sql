CREATE TABLE IF NOT EXISTS admin_menu ( id SERIAL PRIMARY KEY, section VARCHAR(100) NOT NULL, label VARCHAR(150) NOT NULL, sub_label VARCHAR(255) NULL, href VARCHAR(255) NOT NULL, icon VARCHAR(50) NULL, perm VARCHAR(100) NULL, sort_order INT NOT NULL DEFAULT false, is_active BOOLEAN NOT NULL DEFAULT true
 );
